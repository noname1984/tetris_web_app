...
class IShape extends Shape {
	...
	vertical() {
		...
		this.unitArr[1].draw(this.unitArr[1].topLeft[0], this.unitArr[1].topLeft[1]);
		this.unitArr[2].draw(this.unitArr[2].topLeft[0], this.unitArr[2].topLeft[1]);
		this.unitArr[3].draw(this.unitArr[3].topLeft[0], this.unitArr[3].topLeft[1]);
		this.state = 1;
	}
