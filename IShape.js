...
class IShape extends Shape {
	...
	vertical() {
		...
		this.unitArr[3].draw(this.unitArr[3].topLeft[0], this.unitArr[3].topLeft[1] + 3*BASE_PLUS_PADDING);
		this.state = 1;
	}
	...
	horizontal() {
		...
		this.unitArr[3].draw(this.unitArr[3].topLeft[0] +  3*BASE_PLUS_PADDING, this.unitArr[3].topLeft[1]);
		this.state = 0;
	}
	...
	upArrowHandler(x, y) {
		if (this.state === 0) {
			...
			this.unitArr[3].updateCoors(this.unitArr[3].topLeft[0], this.unitArr[3].topLeft[1] + 3*BASE_PLUS_PADDING);
			
			let testResult = Tetris.testRotate(this);
			if (!testResult) {
				this.unitArr[0].updateCoors(this.unitArr[0].topLeft[0], this.unitArr[0].topLeft[1]);
				...
				this.unitArr[3].updateCoors(this.unitArr[3].topLeft[0] + 3*BASE_PLUS_PADDING, this.unitArr[3].topLeft[1]);
			}
			return testResult;
		} else {
			this.unitArr[0].updateCoors(this.unitArr[0].topLeft[0], this.unitArr[0].topLeft[1]);
