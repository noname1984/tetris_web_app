...
class RightLShape extends Shape {
	...
	drawDownBasic() {
		...
		this.unitArr[3].draw(0, BASE_SIZE + PADDING, this.x, this.y);
	};
	...
	drawLeftBasic() {
		...
		this.unitArr[3].draw(0, 0, this.x, this.y);
	};

	drawUpBasic() {
		this.unitArr[0].draw(2*(BASE_SIZE + PADDING), 0, this.x, this.y);
	...
	upArrowHandler(x, y) {
		if (this.state === 0) {
			...
			this.unitArr[1].updateCoors(this.x + BASE_SIZE + PADDING, BASE_SIZE + PADDING + this.y);
			this.unitArr[2].updateCoors(this.x + BASE_SIZE + PADDING, 2*(BASE_SIZE + PADDING) + this.y);
			this.unitArr[3].updateCoors(this.x, this.y);
			...
			if (!testResult) {
				...
				this.unitArr[3].updateCoors(this.x, BASE_SIZE + PADDING + this.y);
			...
			this.unitArr[0].updateCoors(this.x + 2*(BASE_SIZE + PADDING), this.y);
			this.unitArr[1].updateCoors(this.x, BASE_SIZE + PADDING + this.y);
